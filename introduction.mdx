...
<CardGroup cols={2}>
  <Card title="Environment_mod" icon="globe" href="/concepts/environment">
  ...
  <Card title="WaveProperties_mod" icon="wave-sine" href="/concepts/wave-properties">
  ...
  <Card title="WPI_mod" icon="bolt" href="/concepts/wave-particle-interactions">
  ...
  <Card title="LandauDamp_mod" icon="chart-line-down" href="/concepts/landau-damping">
