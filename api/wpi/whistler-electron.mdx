...
description: "API reference for WPIT's whistler–electron sub-module: wpi_params, equations of motion, and nonlinear trapping diagnostics for relativistic electrons."
---
