...
description: "API reference for WPIT's parallel EMIC sub-module: field-aligned ion equations of motion and nonlinear trapping diagnostics, no Bessel functions required."
---
